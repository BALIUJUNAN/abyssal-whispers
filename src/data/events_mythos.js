// 神话知识等级事件 - 64 events (60 + 4 §2补充)
// Directions: 神话感知(20), 禁忌知识(15), 神话反噬(12), 旧日回响(8), 超越者视角(5), 深层禁忌(4)
export const events = [
  // =============================================
  ...
  // =============================================
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "hidden"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "text"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "symbol"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "photo"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "air"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "water"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "tree"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "mirror"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "path"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "light"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "stone"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "fog"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "sound"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "shadow"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "temperature"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["mythos", "perception", "number"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["mythos", "perception", "air"],
  ...
  // =============================================
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["mythos", "forbidden", "book"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["mythos", "forbidden", "stone"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["mythos", "forbidden", "archive"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["mythos", "forbidden", "lighthouse"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "forbidden", "yith"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "forbidden", "deep"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["mythos", "forbidden", "ritual"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["mythos", "forbidden", "photo"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["mythos", "forbidden", "blood"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["mythos", "forbidden", "lighthouse", "diary"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "forbidden", "seal"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "forbidden", "knowledge"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "forbidden", "grove"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "forbidden", "letter"],
  ...
  // =============================================
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "backlash", "name"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "backlash", "notebook"],
    trigger: { areas: ["town_center"], min_mythos: 15, san_lte: 30, probability: 0.2, once_per_run: true },
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "backlash", "shadow"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "backlash", "npc"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "backlash", "memory"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "backlash", "text"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "backlash", "sound"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "backlash", "reality"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "backlash", "self"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "backlash", "time"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "backlash", "body"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["mythos", "backlash", "collapse"],
  ...
  // =============================================
  {
    ...
    weight: 1, tier: "signature", quality_tier: "A", tags: ["mythos", "echo", "contact"],
  ...
  },
  {
    ...
    weight: 1, tier: "signature", quality_tier: "A", tags: ["mythos", "echo", "memory"],
  ...
  },
  {
    ...
    weight: 1, tier: "signature", quality_tier: "A", tags: ["mythos", "echo", "blood"],
  ...
  },
  {
    ...
    weight: 1, tier: "signature", quality_tier: "A", tags: ["mythos", "echo", "stars"],
  ...
  },
  {
    ...
    weight: 1, tier: "signature", quality_tier: "A", tags: ["mythos", "echo", "abyss"],
  ...
  },
  {
    ...
    weight: 1, tier: "signature", quality_tier: "A", tags: ["mythos", "echo", "time"],
  ...
  },
  {
    ...
    weight: 1, tier: "signature", quality_tier: "A", tags: ["mythos", "echo", "seal"],
  ...
  },
  {
    ...
    weight: 1, tier: "signature", quality_tier: "A", tags: ["mythos", "echo", "final"],
  ...
  // =============================================
  {
    ...
    weight: 1, tier: "signature", quality_tier: "A", tags: ["mythos", "transcend", "meta"],
  ...
  },
  {
    ...
    weight: 1, tier: "signature", quality_tier: "A", tags: ["mythos", "transcend", "meta", "final"],
  ...
  // ═══════════════════════════════════════════════════════════
  // §2 补充：深层禁忌 (4) — mythos >= 15, 深度神话知识
  // ═══════════════════════════════════════════════════════════
  {
    id: "mythos_deep_001", name: "封印的真名", type: "mythos", subtype: "forbidden_deep",
    weight: 1, tier: "rare", quality_tier: "A",
    tags: ["mythos", "forbidden", "seal", "name", "deep"],
    trigger: { areas: ["deep_catacombs"], min_mythos: 15, probability: 0.12, once_per_run: true },
    description: "你蹲在封印前面。你用手描摹着符号的轮廓。\n符号在你的指尖下震动。像是在回应你。\n你闭上眼睛。你感到了——一个名字。不是听到的。是感觉到的。从符号的震动里传出来的。\n你张开嘴。名字从你的嘴里出来了。你没有选择说出来——是名字自己出来的。\n名字在空气中回荡了三秒。然后——封印的符号全部亮了。比你见过的任何时候都亮。\n然后——一切恢复了正常。但你知道——你刚才说出了封印的真名。封印听到了你。",
    effects: { san: -3, mythos: 3, add_clue: "clue_mythos_deep_seal_name" },
    event_classification: "超自然遭遇", normalcy_anchor: false,
    choices: []
  },
  {
    id: "mythos_deep_002", name: "海面下的城市", type: "mythos", subtype: "forbidden_deep",
    weight: 1, tier: "rare", quality_tier: "A",
    tags: ["mythos", "forbidden", "sea", "city", "deep"],
    trigger: { areas: ["harbor_district"], min_mythos: 15, probability: 0.1, once_per_run: true, time_phase: ["midnight"] },
    description: "你半夜走到码头。海面很平静。比平时更平静。像是玻璃。\n你低头看水。水很清——比你见过的任何时候都清。\n你看到了——在水下。是一座城市。\n不是沃切斯特。是另一种建筑。线条不属于任何你认识的建筑风格。圆的。流动的。像是活的。\n城市在水下延伸。你看不到尽头。\n你看到了——在城市的中心，有一个建筑。比其他的都大。建筑的形状——你认出来了。是封印的形状。\n封印不是沃切斯特的。封印是水下城市的。封印是那个城市的门。",
    effects: { san: -4, mythos: 3, add_clue: "clue_mythos_deep_underwater_city" },
    event_classification: "超自然遭遇", normalcy_anchor: false,
    choices: []
  },
  {
    id: "mythos_deep_003", name: "旧日支配者的呼吸", type: "mythos", subtype: "forbidden_deep",
    weight: 1, tier: "rare", quality_tier: "A",
    tags: ["mythos", "forbidden", "elder", "breath", "deep"],
    trigger: { areas: ["deep_catacombs"], min_mythos: 20, probability: 0.08, once_per_run: true, san_lte: 20 },
    description: "你走进深渊的最深处。空气变了。\n不是变冷了。是变重了。你的每一步都需要更多的力气。\n你停下来。你听到了——呼吸声。不是你的。不是任何你能辨认的。\n呼吸声从四面八方传来。从墙壁里。从地面里。从天花板里。从空气里。\n你感到了——有什么东西在你身边。很大。大到你无法看到它的全貌。大到你只能看到它的一小部分。\n你伸出手。你的手指碰到了——什么？不是墙壁。不是空气。是某种有温度的表面。\n表面在你的手指下缓慢地起伏。像是在呼吸。\n你知道——你碰到了旧日支配者。不是它的身体。是它的呼吸。",
    effects: { san: -5, mythos: 4, add_clue: "clue_mythos_deep_elder_breath" },
    event_classification: "超自然遭遇", normalcy_anchor: false,
    choices: []
  },
  {
    id: "mythos_deep_004", name: "禁忌知识的代价", type: "mythos", subtype: "forbidden_deep",
    weight: 1, tier: "rare", quality_tier: "A",
    tags: ["mythos", "forbidden", "cost", "knowledge", "deep"],
    trigger: { areas: ["ruins_of_yith"], min_mythos: 20, probability: 0.08, once_per_run: true },
    description: "你翻开了一本书。书页上的文字在发光。\n你读了第一行。你读懂了。你读了第二行。你也读懂了。\n你读了第三行。你的鼻子开始流血。\n你读了第四行。你的耳朵开始嗡鸣。\n你读了第五行。你看到了——不是文字。是画面。是沃切斯特的诞生。是封印的建造。是旧日支配者的沉睡。\n你合上了书。你的鼻子还在流血。你的耳朵还在嗡鸣。\n你知道——你刚才读到的知识是有代价的。你的身体在为你的知识买单。\n但你知道——你不会再忘记。这些知识已经刻在了你的骨头里。",
