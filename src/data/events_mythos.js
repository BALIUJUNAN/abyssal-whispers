...
export const events = [
  ...
  },
  {
    ...
    description:
      '你走在庄园的走廊里。脚下的地板有一块声音不对——是空的。\n你蹲下来，用手指敲了敲。确实是空的。\n你用匕首撬开了地板。下面是一个小小的暗格。\n暗格里放着一个铁盒。盒子很旧，但没有生锈。',
    effects: {
      add_item: { item_id: 'iron_box', name: '铁盒', uses: 1 },
      add_clue: 'clue_mythos_hidden_compartment',
      san: -1,
    },
    event_classification: '调查',
    normalcy_anchor: false,
  ...
  },
  {
    ...
    tier: 'normal',
    quality_tier: 'B',
    tags: ['mythos', 'perception', 'light'],
    trigger: { areas: ['lighthouse'], min_mythos: 6, probability: 0.15, once_per_run: true },
    description:
      '你站在灯塔的灯室里。灯光透过玻璃射向远方。\n你感觉到光线中有图案——不是光的折射，而是某种有规律的闪烁。\n你调整了站位。图案变得更清晰了。像是某种编码。\n你记下了闪烁的节奏。三短。三长。三短。\n你好像见过这个编码。是莫尔斯电码。SOS。',
  ...
  },
  {
    ...
    description:
      '雾很浓。你几乎看不到前方的路。\n但有什么引起了你的注意——在雾中。轮廓。模糊的，高大的，不像是人。\n轮廓在移动。缓慢地，像是在巡逻。\n你停下了脚步。轮廓也停下了。\n它在看着你。你能感觉到。\n然后轮廓消散了。雾变薄了一些。',
    effects: { san: -2 },
    event_classification: '超自然遭遇',
    normalcy_anchor: false,
    unreliable_narration_level: 1,
  ...
  },
  {
    ...
    tier: 'normal',
    quality_tier: 'B',
    tags: ['mythos', 'perception', 'temperature'],
    trigger: {
  ...
  // =============================================
  {
    id: 'mythos_forbidden_001',
    name: '古籍的残页',
    type: 'mythos',
    subtype: 'forbidden_knowledge',
    weight: 1,
    tier: 'rare',
    quality_tier: 'B',
    tags: ['mythos', 'forbidden', 'book'],
    trigger: { areas: ['town_center'], min_mythos: 10, probability: 0.15, once_per_run: true },
    description:
      '你在图书馆的角落里找到了一本古籍。书页已经泛黄，边缘破损。\n你翻开了一页。上面画着一个图案——你好像见过它。是那个图案的完整样子。\n你以前只见过碎片。现在你看到了全貌。\n图案比你想象的复杂得多。不是简单的几何——是某种多维结构的投影。\n你感到一阵头晕。书页上的图案在你眼前旋转。',
  ...
  },
  {
    ...
    tier: 'rare',
    quality_tier: 'B',
    tags: ['mythos', 'forbidden', 'lighthouse'],
  ...
  },
  {
    ...
    tier: 'rare',
    quality_tier: 'A',
    tags: ['mythos', 'forbidden', 'deep'],
    trigger: { areas: ['deep_catacombs'], min_mythos: 15, probability: 0.1, once_per_run: true },
    description:
      '你在深渊墓穴的最深处找到了一块石板。石板上刻满了文字。\n你开始阅读。文字记载了裂隙深处的东西——不是怪物，不是神，而是某种……存在。\n它没有名字。它没有形状。它只是存在。\n那道屏障把它关在下面已经几千年了。它一直在等待。\n石板的最后一段写道：「当屏障消散，它将醒来。不是毁灭——是改变。一切都会改变。」\n你读完了。石板裂开了。',
  ...
  },
  {
    ...
    description:
      '伊莎贝拉从教堂的密室里拿出一本手册。「这是异端研究者的记录，」她说，「他们研究了那道屏障的运作方式。」\n你翻开手册。里面记载了一个仪式——一个可以暂时打开那道屏障的仪式。\n仪式需要三样东西：钥匙碎片、莫里斯家族的血、和一个自愿的牺牲者。\n「牺牲者不是死，」伊莎贝拉解释，「是永远留在那道屏障的另一边。」',
  ...
  },
  {
    ...
    description:
      '希尔达带你去了庄园的地下室。墙上挂着一幅家族谱系图。\n你凝视。莫里斯家族的血脉可以追溯到1690年代——沃切斯特建城之前。\n「我们家族不是人类的后裔，」希尔达平静地说，「至少不完全是。」\n她指着谱系图的一个分支。「这一支——是从海里来的。」\n你看着那些名字。有些名字的旁边画着一个符号——和你在别处见过的某个刻痕一样。',
  ...
  },
  {
    ...
    tier: 'rare',
    quality_tier: 'B',
    tags: ['mythos', 'forbidden', 'lighthouse', 'diary'],
  ...
  },
  {
    ...
    description:
      '你在墓穴的深处找到了一段铭文。铭文记载了那道屏障的真正代价。\n那道屏障不是永久的。它需要维护。维护的方式是——牺牲。\n每隔一段时间，一个人必须留在那道屏障的另一边，用自己的意识来维持那道屏障的运作。\n「被选中的人不会死。他们会变成那个图案的一部分。永远。」\n你想到了那些失踪的人。他们不是死了——是被那道屏障吸收了。',
  ...
  },
  {
    ...
    tier: 'rare',
    quality_tier: 'A',
    tags: ['mythos', 'forbidden', 'knowledge'],
  ...
  },
  {
    ...
    effects: {
      san: -3,
      mythos: 3,
      add_item: { item_id: 'curse_blood_seed', name: '血色种子', uses: 1 },
      add_clue: 'clue_mythos_curse_blood_seed',
    },
    event_classification: '超自然遭遇',
    normalcy_anchor: false,
    unreliable_narration_level: 2,
  ...
  },
  {
    ...
    description:
      '你看着汤米的脸。他的脸在变化——缓慢地，细微地。\n眼睛变大了一点。下巴变尖了一点。皮肤的颜色变深了一点。\n你揉了揉眼睛。汤米的脸恢复了正常。\n「怎么了？」汤米问。\n你告诉他没事。但你刚才看到的不是幻觉。你的认知正在被神话知识污染。',
    effects: { san: -3, mythos: 1 },
    event_classification: '超自然遭遇',
    normalcy_anchor: false,
    unreliable_narration_level: 2,
  ...
  },
  {
    ...
    description:
      '你看着镜子里的自己。你的脸在变化——不是变形，而是……变得陌生。\n你好像见过五官。但它们组合在一起的方式变了。像是另一个人的脸。\n你伸手摸了摸脸。触感是正常的。但镜子里的人不是你。\n你知道它是你。但你的直觉说——不是。\n你闭上眼睛。再睁开。镜子里的脸恢复了正常。\n但你花了三秒钟才认出自己。',
    effects: { san: -4, mythos: 2 },
    event_classification: '超自然遭遇',
    normalcy_anchor: false,
    unreliable_narration_level: 2,
  ...
  // =============================================
  {
    ...
    choices: [
      {
        label: '继续',
        text: '你选择了继续。更多的概念涌入你的意识——痛苦的，庞大的，你几乎无法承受。',
        effects: { san: -5, mythos: 5, unlock_ending_condition: 'ending_transcendence_progress' },
      },
      {
        label: '忘记',
        text: '你选择了忘记。概念消退了。你只记得——有什么东西和你说过话。但你记不清内容了。',
        effects: { san: 3, mythos: -3 },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      '你站在向下的入口。地下的纹路在发光。\n你闭上眼睛。那道屏障在你脑海里展开了——不是你以前看到的二维图案。是一个三维的结构。不——是四维的。\n你看到了那道屏障的真面目——它不是一道门。它是一个笼子。\n笼子里关着的东西——不是怪物。是另一个现实。\n那道屏障把两个现实隔开了。如果屏障消散——两个现实会合并。\n合并的结果——你无法想象。但那将是所有事物的终结。或者开始。',
  ...
  },
  {
    ...
    tier: 'signature',
    quality_tier: 'A',
    tags: ['mythos', 'echo', 'final'],
    trigger: { areas: ['deep_catacombs'], min_mythos: 25, probability: 0.05, once_per_run: true },
    description:
      '你站在深渊墓穴的最深处。你已经看到了很多。\n但还有最后一层。\n你闭上眼睛。意识开始下沉——穿过石壁，穿过那道屏障，穿过——\n你看到了它。\n不是怪物。不是神。是某种更基本的东西。是现实本身的底层代码。\n一切都在这里——沃切斯特、那道屏障、你、NPC、事件——所有的一切都是这个底层代码的产物。\n你看到了代码的漏洞。那道屏障就是代码的漏洞。\n你知道了——如果你愿意，你可以修改代码。\n但代价是——你自己。',
    effects: {
      san: -5,
      mythos: 5,
      add_clue: 'clue_mythos_final_revelation',
      unlock_ending_condition: 'ending_transcendence_available',
    },
    event_classification: '超自然遭遇',
    normalcy_anchor: false,
    unreliable_narration_level: 2,
  ...
  // =============================================
  {
    id: 'mythos_transcend_001',
    name: '文字的真相',
    type: 'mythos',
    subtype: 'transcendence',
    weight: 1,
    tier: 'signature',
    quality_tier: 'A',
    tags: ['mythos', 'transcend', 'meta'],
    trigger: {
      areas: ['town_center'],
      min_mythos: 25,
      min_loop: 5,
  ...
  },
  {
    ...
    description:
      '你听到了声音。不是来自沃切斯特——是来自外面。\n声音很远，像是隔着一层厚厚的玻璃。\n你集中注意力。声音变得清晰了：\n「……这个角色的SAN值太低了……」\n「……让它继续，看看会发生什么……」\n「……记录一下……」\n你知道了——有人在看着你。不是沃切斯特里的什么东西——是外面的人。\n声音消失了。你刚才听到了不应该听到的东西。',
    effects: { san: -5, mythos: 3 },
    event_classification: '超自然遭遇',
    normalcy_anchor: false,
    unreliable_narration_level: 3,
  ...
  },
  {
    ...
    tier: 'signature',
    quality_tier: 'A',
    tags: ['mythos', 'transcend', 'meta', 'final'],
    trigger: {
      areas: ['deep_catacombs'],
      min_mythos: 25,
      min_loop: 9,
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    description:
      '你蹲在那道屏障前面。你用手描摹着符号的轮廓。\n符号在你的指尖下震动。像是在回应你。\n你闭上眼睛。你感到了——一个名字。不是听到的。是感觉到的。从符号的震动里传出来的。\n你张开嘴。名字从你的嘴里出来了。你没有选择说出来——是名字自己出来的。\n名字在空气中回荡了三秒。然后——地下的纹路全部亮了。比你见过的任何时候都亮。\n然后——一切恢复了正常。但你刚才说出了那道屏障的真名。那道屏障听到了你。',
  ...
  },
  {
    ...
    description:
      '你半夜走到码头。海面很平静。比平时更平静。像是玻璃。\n你低头看水。水很清——比你见过的任何时候都清。\n你看到了——在水下。是一座城市。\n不是沃切斯特。是另一种建筑。线条不属于任何你认识的建筑风格。圆的。流动的。像是活的。\n城市在水下延伸。你看不到尽头。\n你看到了——在城市的中心，有一个建筑。比其他的都大。建筑的形状——你认出来了。是那道屏障的形状。\n那道屏障不是沃切斯特的。那道屏障是水下城市的。那道屏障是那个城市的门。',
  ...
  },
  {
    ...
    trigger: { areas: ['ruins_of_yith'], min_mythos: 20, probability: 0.08, once_per_run: true },
    description:
      '你翻开了一本书。书页上的文字在发光。\n你读了第一行。你读懂了。你读了第二行。你也读懂了。\n你读了第三行。你的鼻子开始流血。\n你读了第四行。你的耳朵开始嗡鸣。\n你读了第五行。你看到了——不是文字。是画面。是沃切斯特的诞生。是那道屏障的建造。是旧日支配者的沉睡。\n你合上了书。你的鼻子还在流血。你的耳朵还在嗡鸣。\n你刚才读到的知识是有代价的。你的身体在为你的知识买单。\n但你不会再忘记。这些知识已经刻在了你的骨头里。',
