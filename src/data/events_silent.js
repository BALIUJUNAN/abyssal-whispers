...
export const events = [
  ...
  },
  {
    ...
    distortion_variants: {
      ...
      san_mid:
        '你站在码头边。黄昏的阳光照在海面上。\n海面是金色的。很美。但你注意到金色的表面有东西在移动——不是鱼。太规则了。像是文字。',
      loop_3_plus:
        '你站在码头边。黄昏的阳光照在海面上。和上周目一模一样的金色。\n你知道——你上次也在这里站过。也看到了同样的颜色。\n但你不确定你是在回忆还是在重复。',
    },
    effects: { san: 1 },
    event_classification: '氛围事件',
    normalcy_anchor: true,
  ...
  },
  {
    ...
    distortion_variants: {
      ...
      san_mid:
        '你走在街道上。夜晚的街道很安静。\n你听到了远处的狗叫声。很远，很空旷。\n你循着声音望去。声音来自镇子边缘——但你注意到狗叫的节奏像是在传递信息。三短两长。反复。',
    },
    effects: { san: 1 },
    event_classification: '氛围事件',
    normalcy_anchor: true,
  ...
  },
  {
    ...
    distortion_variants: {
      san_low:
        '你看到孩子们在街上玩耍。他们在追逐、嬉笑。\n你看到最大的那个孩子突然停了下来。她盯着你看了一会儿。\n她没有笑。她说了两个字。你没有听清。但你知道——她说的不是你的名字。是另一个名字。你知道那个名字。但你记不起来。',
      san_mid:
  ...
  },
  {
    ...
    description:
      '你看到海鸥在码头上空盘旋。它们的叫声很清脆。\n你注意到有一只海鸥一直在你头顶盘旋。它没有飞走。其他的海鸥都飞走了。',
    distortion_variants: {
      san_low:
        '你看到海鸥在码头上空盘旋。它们的叫声很清脆。\n你注意到有一只海鸥一直在你头顶盘旋。它的眼睛在看你。\n海鸥的眼睛不是黄色的——是黑色的。纯粹的黑色。没有瞳孔。它在看你。它在数你。',
      san_mid:
  ...
  },
  {
    ...
    description:
      '你走在街道上。街灯亮了。\n灯光照在鹅卵石上，投下了长长的影子。\n你注意到路灯的影子——它们的形状不对。影子的顶端在缓慢地弯曲，像是在向你鞠躬。',
    distortion_variants: {
      san_low:
        '你走在街道上。街灯亮了。\n灯光照在鹅卵石上，投下了长长的影子。\n你的影子在你停下脚步的时候没有停。它又走了两步。然后转过身来看着你。\n你和你的影子对视了三秒。影子先走了。',
      san_mid:
        '你走在街道上。街灯亮了。\n灯光照在鹅卵石上，投下了长长的影子。\n你注意到路灯的影子——它们在向你鞠躬。但今天，你看到其中一个影子在鞠躬的时候，头碰到了地面。路灯的影子不应该碰到地面。',
    },
    effects: { san: 1 },
    event_classification: '氛围事件',
    normalcy_anchor: true,
  ...
  },
  {
    ...
    distortion_variants: {
      ...
      san_mid:
        '你站在码头边。星空很美。\n你开始数星星。数到第一百颗的时候，你发现有一颗星星在你数它的时候灭了。你又数了一遍。又灭了一颗。\n你注意到——被灭掉的两颗星星的位置，和你笔记本上两个事件的编号一样。',
    },
    effects: { san: 1 },
    event_classification: '氛围事件',
    normalcy_anchor: true,
  ...
  },
  {
    ...
    distortion_variants: {
      ...
      san_mid:
        '你看到码头上有渔火。渔民们在火边聊天。\n你数了一下——一共五个人。但影子有六个。\n你仔细看了看第六个影子。它的形状不是人形的——太细长了。像是什么东西站在渔民中间，假装是人。',
    },
    effects: { san: 1 },
    event_classification: '氛围事件',
    normalcy_anchor: true,
  ...
  },
  {
    ...
    distortion_variants: {
      san_low:
        '你感到了风。但风的方向不对——风从四面八方吹来。\n你闭上眼睛。风在你耳边说话。不是低语——是某种你听不懂的语法。\n你睁开眼。地上的落叶排成了一个符号。你认出了它。但你不想认出它。',
      san_mid:
  ...
  },
  {
    ...
    distortion_variants: {
      san_low:
        '你感到了温度的变化。突然变冷了，然后又变热了。\n你看了看自己的皮肤。皮肤上有霜。在夏天。\n霜的形状像文字。你认不出来。但你知道——霜在告诉你什么。三秒后霜化了。你的皮肤上留下了烫伤的痕迹。',
      san_mid:
  ...
  },
  {
    ...
    distortion_variants: {
      san_low:
        '你看到了雾。但雾的形状不对——雾形成了一个圆环。\n圆环的中心是空的。你走近了看。中心不是空的——是有东西在中间。但你看不到它。你能感觉到它。很大。很安静。在等。',
      san_mid:
  ...
  },
  {
    ...
    distortion_variants: {
      san_low:
        '你闻到了气味。但气味不对——是铁锈和海水的味道。\n你看了看自己的手。手上有铁锈色的液体。你没有碰过任何铁器。\n液体在你手上缓慢地写了一个字。你认出了那个字。是封印上的符号。液体干了。字留在了你的皮肤上。',
      san_mid:
  ...
  },
  {
    ...
    distortion_variants: {
      ...
      san_mid:
        '你抬头看云。云的形状不对——云形成了一个符号。\n你认出了符号——和你笔记本上某一页的涂鸦一样。你没有画过那幅涂鸦。\n云在用你自己的涂鸦写字。它读过你的笔记本。',
    },
    effects: { san: -1 },
    event_classification: '氛围事件',
    normalcy_anchor: false,
  ...
  },
  {
    ...
    distortion_variants: {
      ...
      san_mid:
        '你站在码头边。潮汐在退去。太快了。\n你数了数退潮的速度。每秒三米。这不正常。你知道正常的退潮速度是每小时三米。\n退潮在加速。你知道——如果速度继续增加，海床会全部暴露出来。你不确定你想看到海床下面的东西。',
    },
    effects: { san: -1 },
    event_classification: '氛围事件',
    normalcy_anchor: false,
  ...
  },
  {
    ...
    distortion_variants: {
      ...
      san_mid:
        '你抬头看星星。星星的排列不对——星星形成了一个符号。\n你认出了符号。是封印的一部分。但排列方式和封印不一样——是反的。\n封印是锁。星空是钥匙。你知道——钥匙在天上。但你不知道锁在哪里。',
    },
    effects: { san: -1 },
    event_classification: '氛围事件',
    normalcy_anchor: false,
  ...
  },
  {
    ...
    trigger: { areas: ['town_center'], probability: 0.15, once_per_run: true },
    description:
      '你走到广场上。镇民们在低声交谈。\n你听到了几个词：「封印」、「破碎」、「不要说」。\n你知道——镇民们在谈论什么。但他们不敢大声说。',
    distortion_variants: {
      san_low:
        '你走到广场上。镇民们在低声交谈。\n你听到了几个词：「封印」、「破碎」、「不要说」。\n你走近了。镇民们停了下来。他们看着你。然后他们同时指向地面。\n你低头看。广场的鹅卵石缝隙里有光。微弱的。蓝色的。像封印的颜色。\n封印在广场下面。整个沃切斯特都建在封印上面。',
    },
    effects: { san: -1 },
    event_classification: '氛围事件',
    normalcy_anchor: false,
  ...
  // 个人记忆 (12) — 全部添加 san_low 变体，打破"你知道——X还在"模板
  {
    ...
    distortion_variants: {
      san_low:
        '你想起了家乡。但你想不起阳光的颜色了。你想不起街道的名字了。你想不起任何一个人的脸。\n你知道——你有一个家乡。但家乡在你的记忆里变成了一张白纸。\n你低头看笔记本。最后一页上画着一栋房子。你没有画过。但你知道——那是你家。',
      loop_3_plus:
        '你想起了家乡。你想起了阳光、街道、和熟悉的人。\n但这次记忆里多了一个细节——你看到了一个你从未见过的人。他站在你家门口。面朝你。在微笑。\n你知道——你的记忆里不应该有这个人。但他确实在那里。',
    },
    effects: { san: -1 },
    event_classification: '氛围事件',
    normalcy_anchor: false,
  ...
  // 时间错位 (10) — 全部添加 san_low / loop_3_plus 变体，打破"你知道——时间在沃切斯特不正常"模板
  {
    id: 'silent_time_001',
    name: '时间的停顿',
    type: 'silent',
  ...
  },
  {
    ...
    distortion_variants: {
      ...
      loop_3_plus:
        '你感到了时间的加速。和上周目一样的加速。一样的倍率。\n你知道——时间在加速的时候，沃切斯特在快进。快进到什么？你不知道。\n但你知道——每次加速结束后，都会有人消失。',
    },
    effects: { san: -1 },
    event_classification: '氛围事件',
    normalcy_anchor: false,
  ...
  },
  {
    ...
    trigger: { areas: ['town_center'], probability: 0.1, once_per_run: true },
    description:
      '你看到了时间的裂缝。裂缝在空气中闪烁。\n你知道——时间在沃切斯特不正常。裂缝是时间的伤口。',
    distortion_variants: {
      san_low:
        '你看到了时间的裂缝。裂缝在空气中闪烁。\n你走近了。裂缝里有东西。你看到了——裂缝的另一边是另一个沃切斯特。但那个沃切斯特是倒过来的。屋顶在下面。地面在上面。\n裂缝在缓慢地扩大。你知道——裂缝迟早会大到可以让人走过去。你不确定你想走过去。',
    },
    effects: { san: -2 },
    event_classification: '氛围事件',
    normalcy_anchor: false,
  ...
  },
  {
    ...
    trigger: { areas: ['town_center'], probability: 0.1, once_per_run: true },
    description:
      '你听到了时间的回声。回声在空气中回荡。\n你知道——时间在沃切斯特不正常。回声是时间的残响。',
    distortion_variants: {
      san_low:
        '你听到了时间的回声。回声在空气中回荡。\n你听到了自己的声音。但不是现在的你——是很久以前的你。你在说一句话。你听不清内容。但你知道——那是你在沃切斯特说的第一句话。\n回声在你的耳朵里变成了嗡鸣。嗡鸣在说：你已经在这里很久了。',
    },
    effects: { san: -1 },
    event_classification: '氛围事件',
    normalcy_anchor: false,
  ...
  },
  {
    ...
    distortion_variants: {
      ...
      loop_3_plus:
        '你走进森林。树木不再低语。和上周目一样的沉默。\n你知道——森林的低语和沉默是交替的。上周目是低语。这个周目是沉默。下周目又是低语。\n你知道——沉默的周目比低语的周目更危险。因为沉默意味着树木在做某件事。某件不需要语言的事。',
    },
    effects: { san: 1 },
    event_classification: '氛围事件',
    normalcy_anchor: true,
  ...
  },
  {
    ...
    description:
      '你走进墓穴。空气很重。石壁上刻着名字。\n你知道——这些名字是死人的。但你注意到了——其中一个名字是新的。刻痕还没干。\n你知道——有人最近来过这里。刻了一个名字。但没有人告诉你谁死了。',
    distortion_variants: {
      san_low:
        '你走进墓穴。空气很重。石壁上刻着名字。\n你知道——这些名字是死人的。但你注意到了——所有的名字都在你的笔记本里出现过。\n你翻开笔记本。笔记本上的名字和石壁上的名字完全一致。顺序也一样。\n你的笔记本是一份死亡名单。或者——石壁是你的笔记本的投影。',
      loop_3_plus:
        '你走进墓穴。空气很重。石壁上刻着名字。和上周目一样的名字。\n但你注意到了——名字的顺序变了。上周目排在第三位的名字现在排在第一位。\n你知道——名字的顺序代表的是死亡的顺序。顺序变了。意味着死亡的顺序变了。',
    },
    effects: { san: 1 },
    event_classification: '氛围事件',
    normalcy_anchor: true,
  ...
  },
  {
    ...
    description:
      '你走进灯塔。灯室里很空。灯光已经熄灭了。\n你知道——灯塔是沃切斯特的眼睛。但眼睛闭上了。\n你知道——灯塔沉默的时候，沃切斯特就失去了方向。所有方向都通向同一个地方。',
    distortion_variants: {
      san_low:
        '你走进灯塔。灯室里很空。灯光已经熄灭了。\n你知道——灯塔是沃切斯特的眼睛。但眼睛闭上了。\n你走到了灯室的最顶端。你看到了——灯的灯芯还在。但灯芯在燃烧黑色的火焰。黑色的光。你看到了黑暗在发光。\n你知道——灯塔没有沉默。它在用黑暗说话。',
      loop_3_plus:
        '你走进灯塔。灯室里很空。灯光已经熄灭了。和上周目一样。\n你知道——灯塔每周目都在同一个时间熄灯。但你注意到了——熄灯的持续时间在变长。\n上周目熄灯了三分钟。这个周目熄灯了五分钟。你知道——灯塔在倒计时。',
    },
    effects: { san: 1 },
    event_classification: '氛围事件',
    normalcy_anchor: true,
  ...
  },
  {
    ...
    description:
      '你走进禁林。树木比外面的更老。更粗。更沉默。\n你知道——禁林是沃切斯特的根。所有的树木都从禁林里长出来。\n你知道——禁林的沉默不是因为没有声音。是因为声音被树木吸收了。树木在用声音生长。',
    distortion_variants: {
      san_low:
        '你走进禁林。树木比外面的更老。更粗。更沉默。\n你知道——禁林是沃切斯特的根。所有的树木都从禁林里长出来。\n你蹲下来。用手扒开地上的落叶。落叶下面是树根。树根在缓慢地移动。朝你的方向。\n你知道——禁林的树木在用根部感知你。它们知道你在这里。它们在决定要不要接纳你。',
      loop_3_plus:
        '你走进禁林。树木比外面的更老。更粗。更沉默。和上周目一样的沉默。\n你知道——禁林的沉默是恒定的。它不受循环影响。\n但你注意到了——树干上的刻痕。你上周目留下的刻痕。刻痕愈合了。树干恢复了原样。但愈合的位置——比原来高了三厘米。树木在生长。用你的刻痕。',
    },
    effects: { san: 1 },
    event_classification: '氛围事件',
    normalcy_anchor: true,
  ...
  },
  {
    ...
    description:
      '你走进深渊。黑暗在你面前展开。没有光。没有声音。没有方向。\n你知道——深渊是沃切斯特的底。所有的秘密都沉在深渊里。\n你知道——深渊的沉默不是空虚。是某种东西在屏住呼吸。在等你走到足够近的地方。',
    distortion_variants: {
      san_low:
        '你走进深渊。黑暗在你面前展开。没有光。没有声音。没有方向。\n你知道——深渊是沃切斯特的底。所有的秘密都沉在深渊里。\n你伸出手。黑暗触碰了你的手指。不是冷——是温热的。三十六度五。和你一样。\n黑暗在用你的温度呼吸。你知道——黑暗不是空的。黑暗是一种生物。而你正在它体内。',
      loop_3_plus:
        '你走进深渊。黑暗在你面前展开。和上周目一样的黑暗。\n你知道——深渊的沉默是循环的一部分。但你注意到了——深渊比上周目更深了。你走了更多的台阶才到底。\n你知道——深渊每周目都在生长。它在往下长。朝着某个你知道但不想知道的地方。',
    },
    effects: { san: 1 },
    event_classification: '氛围事件',
    normalcy_anchor: true,
  ...
  // 结局余波 (3) — 添加 loop_3_plus 变体
  {
    ...
    description:
      '你回到了沃切斯特。一切看起来和上次一样。\n但你注意到了——空气中有一种味道。是铁锈和海水的味道。\n你知道——这是结局的余味。你上次的结局留下了痕迹。',
    distortion_variants: {
      san_low:
        '你回到了沃切斯特。一切看起来和上次一样。\n但你注意到了——空气中有一种味道。是铁锈和海水的味道。\n你低头看自己的手。手上有伤疤。伤疤的形状——你认出来了。是你上次结局的方式留下的。\n你的身体记得结局。即使你的意识不记得。',
      loop_3_plus:
        '你回到了沃切斯特。一切看起来和上次一样。和上上次一样。\n但你注意到了——铁锈和海水的味道变浓了。每个周目都浓一点。\n你知道——结局在积累。每次结局都在沃切斯特的空气里留下残渣。残渣在增加。',
    },
    effects: { san: -1 },
    event_classification: '氛围事件',
    normalcy_anchor: false,
  ...
  },
  {
    ...
    description:
      '你站在封印前面。封印的符号在发光。\n但你注意到了——符号的光芒里有回响。是你上次结局的回响。\n你知道——结局的回响还在。但它们正在消散。',
    distortion_variants: {
      san_low:
        '你站在封印前面。封印的符号在发光。\n但你注意到了——符号的光芒里有回响。是你上次结局的回响。\n回响在说话。用你的声音。说的是你上次说的最后一句话。\n你知道——封印记录了你的每一次结局。封印是你的死亡日记。',
      loop_3_plus:
        '你站在封印前面。封印的符号在发光。\n但你注意到了——符号的光芒里有回响。不是上次的回响。是所有的回响。同时在播放。\n你知道——封印在重播你的每一次结局。它在学习。它在预测你的下一次结局。',
    },
    effects: { san: -1 },
    event_classification: '氛围事件',
    normalcy_anchor: false,
