...
export const events = [
  ...
  // =============================================
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "martha", "fisher"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "elias", "tommy"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "hilda", "isabella"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "joshua", "fisher"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "edgar", "elias"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "martha", "isabella"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "tommy", "hilda"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "fisher", "elias"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "joshua", "martha"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "isabella", "edgar"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "hilda", "fisher"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "tommy", "joshua"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "elias", "martha"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "hilda", "elias"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "martha", "tommy"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "fisher", "isabella"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "joshua", "elias"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "hilda", "martha"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "tommy", "edgar"],
  ...
  // =============================================
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "secret", "letter"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "secret", "item"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "secret", "peek"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "secret", "relationship"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "secret", "pass"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "secret", "commission"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "secret", "trust"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "secret", "token"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "secret", "discovery"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "secret", "martha"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "secret", "isabella"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "secret", "joshua"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "secret", "map"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "secret", "key"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "secret", "manuscript"],
  ...
  // =============================================
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["npc", "cross", "triangle", "seal"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["npc", "cross", "triangle", "blood"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["npc", "cross", "triangle", "lighthouse"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["npc", "cross", "triangle", "ritual"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["npc", "cross", "triangle", "investigation"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["npc", "cross", "triangle", "morris"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["npc", "cross", "triangle", "harbor"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["npc", "cross", "triangle", "seal", "maintenance"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["npc", "cross", "triangle", "escape"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "A", tags: ["npc", "cross", "triangle", "final"],
  ...
  // =============================================
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "death", "martha"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "death", "elias"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "death", "hilda"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "death", "tommy", "anger"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "death", "joshua", "silence"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "death", "isabella", "prayer"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "death", "fisher", "legacy"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "death", "edgar", "manuscript"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "death", "hilda", "legacy"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "B", tags: ["npc", "cross", "death", "martha", "bar"],
  ...
  },
  {
    ...
    weight: 1, tier: "normal", quality_tier: "A", tags: ["npc", "cross", "death", "tommy", "farewell"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["npc", "cross", "death", "final"],
  ...
  // =============================================
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["npc", "cross", "team", "lighthouse"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["npc", "cross", "team", "catacombs"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["npc", "cross", "team", "manor"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["npc", "cross", "team", "forest"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["npc", "cross", "team", "harbor"],
  ...
  },
  {
    ...
    weight: 1, tier: "rare", quality_tier: "B", tags: ["npc", "cross", "team", "ruins"],
  ...
  },
  {
    ...
    weight: 1, tier: "signature", quality_tier: "A", tags: ["npc", "cross", "team", "deep"],
  ...
  },
  {
    ...
    weight: 1, tier: "signature", quality_tier: "A", tags: ["npc", "cross", "team", "final"],
  ...
  // ═══════════════════════════════════════════════════════════
  {
    id: "npc_legacy_martha", name: "玛莎的遗愿", type: "npc_cross", subtype: "legacy",
    weight: 1, tier: "normal", quality_tier: "A",
    tags: ["npc", "legacy", "martha", "death"],
    trigger: { areas: ["harbor_district"], probability: 0.3, once_ever: true, npc_dead: ["玛莎·格雷"] },
    description: "你走进酒吧。玛莎不在了。吧台上放着一个信封，上面写着你的名字。\n你打开信封。里面是一把钥匙和一张纸条。\n「如果你读到这封信，说明我已经不在了。地下室的柜子里有东西。是我这些年收集的。关于沃切斯特的真相。」\n「钥匙在你手里了。做出你的选择。」\n你把钥匙握在手里。钥匙是温热的。像是刚从某个人的手里传过来的。",
    effects: { add_clue: "clue_legacy_martha_basement", add_item: { item_id: "legacy_martha_key", name: "玛莎的钥匙", uses: 1 } },
    event_classification: "NPC互动", normalcy_anchor: false,
    choices: [
      { label: "去地下室", text: "你打开了地下室的柜子。里面有三本笔记、一瓶药水、和一张沃切斯特的地图。地图上标注了几个你从未去过的地方。", effects: { add_clue: "clue_legacy_martha_map", san: -2, add_item: { item_id: "legacy_martha_potion", name: "玛莎的药水", uses: 1 } } },
      { label: "把钥匙留在吧台上", text: "你把钥匙放回了信封上。有些秘密不该被打开。", effects: { humanity: 2 } }
    ]
  },
  {
    id: "npc_legacy_fisher", name: "老费舍的航海图", type: "npc_cross", subtype: "legacy",
    weight: 1, tier: "normal", quality_tier: "A",
    tags: ["npc", "legacy", "fisher", "death"],
    trigger: { areas: ["harbor_district"], probability: 0.3, once_ever: true, npc_dead: ["老费舍"] },
    description: "老费舍的渔船还在码头。船上没有人。\n你走上船。船舱里很暗。你划亮了火柴。\n墙上钉着一张航海图。图上画满了标记——圈、叉、虚线。你认出了其中一些符号。和封印上的符号一样。\n航海图的角落里写着一行字：「海面下有门。月圆之夜。潮水最低的时候。」\n你知道——老费舍知道的比他说的多得多。",
    effects: { add_clue: "clue_legacy_fisher_chart", san: -2, mythos: 1 },
    event_classification: "调查", normalcy_anchor: false,
    choices: []
  },
  {
    id: "npc_legacy_elias", name: "伊莱亚斯的研究笔记", type: "npc_cross", subtype: "legacy",
    weight: 1, tier: "normal", quality_tier: "A",
    tags: ["npc", "legacy", "elias", "death", "mythos"],
    trigger: { areas: ["whispering_forest"], probability: 0.25, once_ever: true, npc_dead: ["伊莱亚斯·沃德"] },
    description: "你在伊莱亚斯崩溃的那个地方找到了一个铁盒。铁盒埋在树根下面。\n你打开铁盒。里面是一叠笔记。伊莱亚斯的笔迹。\n笔记的内容——是关于封印的研究。他画了封印的结构图。他标注了每一个符号的含义。\n最后一页写着：「封印不是锁。封印是桥。桥的两端是两个世界。」\n「打破封印不是释放。是合并。」\n你知道——伊莱亚斯疯了。但他的研究可能是对的。",
    effects: { add_clue: "clue_legacy_elias_research", san: -3, mythos: 2 },
    event_classification: "调查", normalcy_anchor: false,
    choices: []
  },
  {
    id: "npc_legacy_hilda", name: "希尔达的守护者残影", type: "npc_cross", subtype: "legacy",
    weight: 1.5, tier: "rare", quality_tier: "A",
    tags: ["npc", "legacy", "hilda", "death", "seal"],
    trigger: { areas: ["deep_catacombs"], probability: 0.2, once_ever: true, npc_dead: ["希尔达·莫里斯"], min_loop: 3 },
    description: "你走进封印核心。封印的符号在发光。\n但你注意到了——符号的光芒里有人影。很淡，几乎是透明的。\n你认出了人影的轮廓。是希尔达。\n她面朝封印。双手放在符号上。她的嘴在动——在念诵什么。\n你走近了。人影消失了。但你听到了她最后一句话的回声：\n「守好它。」\n你知道——希尔达没有真正离开。她成为了封印的一部分。",
    effects: { san: -2, mythos: 2, add_clue: "clue_legacy_hilda_guardian" },
    event_classification: "超自然遭遇", normalcy_anchor: false,
    choices: [
      { label: "触摸封印", text: "你把手放在封印上。符号的光芒变强了。你感到了——温暖。不是封印的温度。是希尔达的温度。", effects: { san: 1, mythos: 1 } },
      { label: "后退", text: "你后退了一步。封印的光芒恢复了正常。你知道——有些存在不需要你的触碰。", effects: {} }
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    id: "npc_web_martha_fisher_conflict", name: "玛莎与老费舍的决裂", type: "npc_cross", subtype: "relationship_chain",
    weight: 1, tier: "normal", quality_tier: "A",
    tags: ["npc", "web", "martha", "fisher", "conflict"],
    trigger: { areas: ["harbor_district"], npc_trust_gte: { "玛莎·格雷": 3, "老费舍": 3 }, probability: 0.15, once_per_run: true, npc_alive: ["玛莎·格雷", "老费舍"] },
    description: "你走进酒吧。气氛不对。\n玛莎站在吧台后面。老费舍坐在角落。他们没有说话。\n你走近玛莎。她看了你一眼。\n「他又要一个人出海了，」她说，声音很冷，「这次我不拦他。」\n老费舍站起来。「她不懂。海里有我需要的东西。」\n「你需要的是活着！」玛莎的声音提高了。\n他们同时看着你。你需要选边。但你知道——这次选择会影响他们两个人。",
    effects: {},
    event_classification: "NPC互动", normalcy_anchor: false,
    choices: [
      { label: "支持玛莎，阻止老费舍出海", text: "你挡在老费舍面前。「别去了。」老费舍沉默了很久。然后他坐下了。\n玛莎松了一口气。但老费舍的眼神——像是失去了什么。", effects: { npc_trust: { "玛莎·格雷": 2, "老费舍": -2 }, add_run_memory: { text: "阻止了老费舍出海。玛莎感激，但老费舍沉默了。" } } },
      { label: "支持老费舍，陪他出海", text: "「我陪他去。」玛莎看了你一眼。她的表情——不是愤怒。是失望。\n你和老费舍走出了酒吧。海风很大。", effects: { npc_trust: { "玛莎·格雷": -2, "老费舍": 2 }, add_run_memory: { text: "陪老费舍出海。玛莎失望了。" } } },
      { label: "两不相帮", text: "你没有说话。玛莎叹了口气。老费舍继续喝酒。\n沉默持续了很久。", effects: { add_run_memory: { text: "在玛莎和老费舍的争执中保持了沉默。" } } }
    ]
  },
  {
    id: "npc_web_isabella_hilda_alliance", name: "伊莎贝拉与希尔达的秘密同盟", type: "npc_cross", subtype: "relationship_chain",
    weight: 1, tier: "normal", quality_tier: "A",
    tags: ["npc", "web", "isabella", "hilda", "alliance", "seal"],
    trigger: { areas: ["town_center"], npc_trust_gte: { "伊莎贝拉·韦伯": 3, "希尔达·莫里斯": 3 }, probability: 0.12, once_per_run: true, npc_alive: ["伊莎贝拉·韦伯", "希尔达·莫里斯"], min_loop: 2 },
    description: "你在教堂的密室里发现了伊莎贝拉和希尔达。她们在看一张地图。\n地图上画着沃切斯特的地下结构。你认出了——是封印的通道网络。\n伊莎贝拉看到你，没有藏地图。\n「你来得正好，」她说，「我们需要第三个人。」\n希尔达点了点头。「封印在衰弱。我们需要找到三个锚点。」\n「三个锚点分散在沃切斯特的不同区域。我们需要同时激活它们。」\n伊莎贝拉看着你。「你愿意帮忙吗？」",
    effects: { add_clue: "clue_web_seal_anchors" },
    event_classification: "NPC互动", normalcy_anchor: false,
    choices: [
      { label: "答应帮忙", text: "「我帮你们。」伊莎贝拉和希尔达交换了一个眼神。希尔达微微笑了。\n「谢谢你。」她说。声音很轻。像是在说一个很久没说过的话。", effects: { npc_trust: { "伊莎贝拉·韦伯": 2, "希尔达·莫里斯": 2 }, add_flag: "flag_seal_anchors_quest", add_run_memory: { text: "加入了伊莎贝拉和希尔达的封印锚点任务。" } } },
      { label: "拒绝", text: "「我需要更多信息。」伊莎贝拉看了你一眼。她的眼神——不是失望。是理解。\n「你会回来的。」她说。", effects: { add_run_memory: { text: "拒绝了封印锚点任务。但你知道——你迟早会参与。" } } }
    ]
  },
  {
    id: "npc_web_tommy_joshua_trade", name: "汤米与约书亚的交易", type: "npc_cross", subtype: "relationship_chain",
    weight: 1, tier: "normal", quality_tier: "B",
    tags: ["npc", "web", "tommy", "joshua", "trade", "resource"],
    trigger: { areas: ["town_center"], npc_trust_gte: { "汤米·陈": 2, "约书亚·布莱克": 2 }, probability: 0.15, once_per_run: true, npc_alive: ["汤米·陈", "约书亚·布莱克"] },
    description: "你走进汤米的店铺。约书亚也在。他们正在交易。\n汤米在看一本旧书。约书亚在看一把匕首。\n「这把匕首值两瓶药水，」约书亚说。\n「一瓶半，」汤米说。\n他们看到你，停了下来。\n「你来得正好，」汤米说，「你来定价。」",
    effects: {},
    event_classification: "NPC互动", normalcy_anchor: false,
    choices: [
      { label: "帮汤米说话", text: "「一瓶半合理。」约书亚看了你一眼，叹了口气。成交了。", effects: { npc_trust: { "汤米·陈": 1, "约书亚·布莱克": -1 }, add_run_memory: { text: "帮汤米压了约书亚的价格。" } } },
      { label: "帮约书亚说话", text: "「两瓶药水，这把匕首值这个价。」汤米皱了皱眉，但还是同意了。", effects: { npc_trust: { "汤米·陈": -1, "约书亚·布莱克": 1 }, add_run_memory: { text: "帮约书亚抬了价格。" } } },
      { label: "提出公平方案", text: "「一瓶药水加一条线索。」他们交换了一个眼神。然后都点了点头。", effects: { npc_trust: { "汤米·陈": 1, "约书亚·布莱克": 1 }, add_run_memory: { text: "帮汤米和约书亚达成了公平交易。" } } }
    ]
  },
  {
    id: "npc_web_mass_betrayal", name: "集体的背叛", type: "npc_cross", subtype: "relationship_chain",
    weight: 1.5, tier: "rare", quality_tier: "A",
    tags: ["npc", "web", "betrayal", "collective"],
    trigger: { areas: ["town_center"], probability: 0.08, once_ever: true, min_loop: 4, san_lte: 25 },
    description: "你走进广场。镇民们聚集在一起。\n他们看到你，安静了。\n然后——他们同时转身。面朝你。\n你认出了他们的脸。玛莎。老费舍。汤米。约书亚。伊莎贝拉。\n他们的眼睛——不是他们的眼睛。是同一种眼神。空洞的。统一的。\n他们同时开口：\n「你知道得太多了。」\n声音是他们的。但语调不是。是某种更深层的东西在说话。\n然后——他们恢复了正常。好像什么都没发生。玛莎在擦杯子。老费舍在补网。\n你知道——刚才发生的事是真实的。沃切斯特的镇民——不是他们自己。",
  ...
  // ═══════════════════════════════════════════════════════════
  {
    id: "npc_team_lighthouse_lower", name: "灯塔下层的入口", type: "npc_cross", subtype: "team_requirement",
    weight: 1, tier: "normal", quality_tier: "A",
    tags: ["npc", "team", "lighthouse", "fisher", "joshua"],
    trigger: { areas: ["lighthouse"], npc_trust_gte: { "老费舍": 3 }, probability: 0.15, once_per_run: true, npc_alive: ["老费舍"], min_loop: 3 },
    description: "你站在灯塔的底层。地板上有一扇活板门。\n你用力拉了一下。门不动。锁很复杂——不是普通的锁。是某种机关。\n老费舍走过来。他看了一眼锁。\n「我见过这种锁，」他说，「三十年前。灯塔还没废弃的时候。」\n他从口袋里掏出一根铁丝。插进锁孔。转了三下。\n锁开了。\n「我年轻的时候在这里工作过，」他说，「下面——你确定要看吗？」",
    effects: { add_clue: "clue_team_lighthouse_lower" },
    event_classification: "调查", normalcy_anchor: false,
    choices: [
      { label: "一起下去", text: "你和老费舍一起走下了楼梯。楼梯很长。空气越来越冷。\n底部是一间房间。房间里有一台机器。机器的形状——你认出来了。和封印上的符号一样。", effects: { add_clue: "clue_team_lighthouse_machine", san: -3, mythos: 1, npc_trust: { "老费舍": 1 } } },
      { label: "一个人下去", text: "「我一个人去。」老费舍看了你一眼。他没有坚持。\n「小心。」他说。你一个人走下了楼梯。", effects: { add_clue: "clue_team_lighthouse_machine", san: -3 } },
      { label: "不下去", text: "「今天不下去。」老费舍点了点头。他把活板门关上了。\n「门会一直在。」他说。", effects: { add_run_memory: { text: "发现了灯塔下层入口，但没有下去。" } } }
    ]
  },
  {
    id: "npc_team_forest_deep", name: "禁忌之林的向导", type: "npc_cross", subtype: "team_requirement",
    weight: 1, tier: "normal", quality_tier: "A",
    tags: ["npc", "team", "forest", "elias", "forbidden_grove"],
    trigger: { areas: ["whispering_forest"], npc_trust_gte: { "伊莱亚斯·沃德": 3 }, probability: 0.12, once_per_run: true, npc_alive: ["伊莱亚斯·沃德"], min_loop: 3 },
    description: "你站在森林的边缘。前方是禁忌之林。\n你知道——禁忌之林不是普通的森林。进去的人不一定能出来。\n伊莱亚斯走到你身边。\n「我来过这里，」他说，「三次。每次都是一个人。每次都在同一个地方迷路。」\n他看着你。\n「但这次不一样。我有你。你有我。」\n他从口袋里掏出一根绳子。\n「系在腰上。如果我们走散了——拉绳子。」",
    effects: {},
    event_classification: "NPC互动", normalcy_anchor: false,
    choices: [
      { label: "一起进入", text: "你们系好了绳子。一起走进了禁忌之林。\n树木比外面的更老。更粗。更沉默。\n你走了二十分钟。没有迷路。伊莱亚斯在前面带路。他知道路。", effects: { add_clue: "clue_team_forest_deep_path", npc_trust: { "伊莱亚斯·沃德": 2 }, san: -2 } },
      { label: "让伊莱亚斯一个人去", text: "「你去吧。我在这里等你。」伊莱亚斯看了你一眼。\n「你确定？」你点了点头。他转身走进了森林。\n你等了三个小时。他没有回来。", effects: { npc_trust: { "伊莱亚斯·沃德": -2 }, add_run_memory: { text: "让伊莱亚斯一个人进了禁忌之林。他没有回来。" } } }
    ]
  }
];
