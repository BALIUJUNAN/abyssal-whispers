...
export var WORLD_DECAY_NARRATIVES = [
  ...
  },
  {
    ...
    maxDay: 10,
    minCorruption: 20,
    text: '公告栏上多了一张新的告示。不是失踪人口——是禁止夜间外出的通知。',
  },
  {
    minDay: 7,
    maxDay: 14,
  ...
  },
  {
    ...
    maxDay: 14,
    minCorruption: 30,
    text: '你路过码头时，海水的颜色不太对。比昨天更深了。',
  },
  {
    minDay: 10,
    maxDay: 18,
    minCorruption: 35,
    text: '杂货店关门了。门上贴着一张纸条："库存已空。"',
  },
  {
    minDay: 10,
    maxDay: 18,
    minCorruption: 40,
    text: '你安全屋的墙壁上出现了水渍。不是漏水——更像是从里面渗出来的。',
  },
  {
    minDay: 14,
    maxDay: 21,
    minCorruption: 45,
    text: '街上的人越来越少了。你不确定他们是搬走了，还是消失了。',
  },
  {
    minDay: 14,
    maxDay: 21,
    minCorruption: 50,
    text: '你听到了海浪声。但你在镇中心。离海有三英里。',
  },
  {
    minDay: 18,
    maxDay: 25,
    minCorruption: 55,
    text: '路灯全部熄灭了。沃切斯特在月光下看起来像一座坟墓。',
  },
  {
    minDay: 18,
    maxDay: 25,
    minCorruption: 60,
    text: '你的影子比你慢了半步。你确定以前不是这样的。',
  },
  ...
  { minDay: 25, maxDay: 28, minCorruption: 80, text: '沃切斯特的地面在震动。不是地震——是呼吸。' },
  {
    ...
    maxDay: 28,
    minCorruption: 85,
    text: '你听到了钟声。不是十三下。也不是十四下。你数不清了。',
  },
  {
    minDay: 27,
    maxDay: 28,
    minCorruption: 90,
    text: '雾变成了红色。你已经不记得雾是什么颜色的了。',
  },
];
