...
function applyTextHallucination(text, san) {
  if (!text) return text;
...
function maybeGetFakeMessage(san, loopCount) {
...
function maybeInsertFalseMemory(narr, san, loopCount, day) {
...
// Activates at stage.level >= 2 (perception_shift, SAN 40-54)
function corruptEventWeights(candidates, san) {
